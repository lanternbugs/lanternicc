...
if(consoleSubframes[a]!=null)
{
	...
	{ consoleSubframes[a].updateComboBox(conNumber);
		consoleSubframes[a].setTitle(consoleSubframes[a].consoleTitle + sharedVariables.consoleTabTitles[conNumber]);

	}
	//consoleSubframes[a].overall.recreate();// not sure why i need this yet. more investigation. tabs wouldnt resize after tab name
}// end if
}//end method
